        ...
        {!loading && 
          <Fragment>
              <div className='mt-8 mb-6 md:my-12 flex justify-between items-center'>
                <div >
                  <h1 className='heading-l text-inv-0C0E16 pb-1'>Invoices</h1>
                  <p className='body text-inv-7E88C3'><span className="hidden md:inline-block">There are</span> 7 <span className="hidden md:inline-block">total</span> invoices</p>
                </div>
                
                <InvoiceStatusFilter />
      
                <div >
                  <button className='h-14 pr-8 btn btn-new  bg-inv-7C5DFA text-white hover:bg-inv-9277FF duration-200' onClick={(e) => toggleInvoiceFormVisible(true)}>
